...
print("LogReg")
print("-------------------------------------")
#Get Calculation with LOGREG based on Quality as Dependant Variable
CustomizedLogReg2(df_bin,x_columns,y_columns,1,"")
#Get Calculation with LOGREG based on Wine Type as Dependant Variable
CustomizedLogReg2(df_bin,x_columns,y_columns2,2,"")
#Get Calculation with LOGREG based on Quality Group as Dependant Variable
...
#Get Calculation with NEURAL NETWORK USING NO PCA based on Quality as Dependant Variable
NeuralNetworkModel2(X_train,Y_train,X_test,Y_test,x_columns,y_columns,1,100,2100,100)
#Get Calculation with NEURAL NETWORK USING  NO PCA based on Wine Type as Dependant Variable
NeuralNetworkModel2(X_train2,Y_train2,X_test2,Y_test2,x_columns,y_columns2,2,100,2100,100)
#Get Calculation with NEURAL NETWORK USING  NO PCA based on Quality Group as Dependant Variable
...
print("-------------------------------------")
#Get Calculation with LOGREG USING PCA COMPONENT = 3 based on Quality as Dependant Variable
x_pca,y_pca,n_components = PCAPrep(df_bin,x_columns,y_columns,3)
CustomizedLogRegWithPCA2(x_pca,y_pca,x_columns,y_columns,1,n_components)
#Get Calculation with LOGREG USING PCA COMPONENT = 3 based on WINE TYPE as Dependant Variable
...
#Get Calculation with LOGREG USING PCA COMPONENT = 3 based on Quality Group as Dependant Variable
...
#Get Calculation with LOGREG USING PCA COMPONENT = 1 based on WINE TYPE as Dependant Variable
...
#Get Calculation with LOGREG USING PCA COMPONENT = 2 based on WINE TYPE as Dependant Variable
...
x_pca3,y_pca3,n_components = PCAPrep(df_bin,x_columns,y_columns3,3)
CustomizedLogRegWithPCA2(x_pca3,y_pca3,x_columns,y_columns3,3,n_components)
#Get Calculation with LOGREG USING PCA COMPONENT = 1 based on Quality Group as Dependant Variable
...
#Get Calculation with LOGREG USING PCA COMPONENT = 2 based on Quality Group as Dependant Variable
